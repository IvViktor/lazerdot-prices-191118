...
<div id="content">
    ...
    <div class="container">
		...
		<form method="POST" id="reviews-form">
			...
			<textarea name="vivan_reviews_visitor_review" rows="4" placeholder="Отсавьте отзыв тут" required></textarea>
			<div class="g-recaptcha" data-sitekey="6LfJI4kUAAAAAJC17ITIMUYwwFVTxfU_t8mRG27K" data-size="compact"></div>
