...
//    wp_enqueue_style('bootstrap', get_stylesheet_directory_uri() . '/css/bootstrap.css');
    ...
    if (is_page_template('page-about.php') || is_page_template('page-about-editable.php')){
...
function add_scripts() {
    ...
    wp_register_script("modernizr", get_stylesheet_directory_uri() . "/js/vendor/modernizr-2.6.2.min.js", array("jquery"), null);
...
function lazer_widgets_init() {
    register_sidebar( array(
        'name' => __( 'Телефон1', '' ),
        'id' => 'top-area-1',
        'description' => __( 'Телефон1', '' ),
        'before_widget' => '',
        'after_widget' => '',
        'before_title' => '<h3>',
        'after_title' => '</h3>',
...
add_action( 'widgets_init', 'lazer_widgets_init' );
